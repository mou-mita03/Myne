...
import com.starry.myne.recommendations.MvpRecommendationEngine
...
class MainModule {
    ...
    @Provides
    fun provideReviewDao(myneDatabase: MyneDatabase) = myneDatabase.getReviewDao()

    @Provides
    fun provideCatalogManagementDao(myneDatabase: MyneDatabase) = myneDatabase.getCatalogManagementDao()

    @Singleton
    @Provides
    fun provideRecommendationEngine(): RecommendationEngine = MvpRecommendationEngine()
    ...
    @Provides
    @Singleton
    fun provideReadingStreakStore(
        @ApplicationContext context: Context
    ) = ReadingStreakStore(context = context)
}
