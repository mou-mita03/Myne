...
class LibraryViewModel @Inject constructor(
    ...
    fun toggleFavorite(item: LibraryItem) {
        viewModelScope.launch(Dispatchers.IO) {
            libraryDao.updateFavorite(item.id, !item.isFavorite)
    ...
    fun getTokenBalance(): Int = dailyTokenManager.getTokenBalance()

    fun tryConsumeToken(): Boolean = dailyTokenManager.tryConsumeToken()
