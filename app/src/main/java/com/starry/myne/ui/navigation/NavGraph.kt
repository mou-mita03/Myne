...
import com.starry.myne.ui.screens.auth.composables.AuthScreen
import com.starry.myne.ui.screens.detail.composables.BookDetailScreen
import com.starry.myne.ui.screens.dashboard.DashboardScreen
...
fun NavGraph(
    ...
    NavHost(
        ...
        composable(route = Screens.DashboardScreen.route, enterTransition = { enterTransition() }, popExitTransition = { popExitTransition() }) {
